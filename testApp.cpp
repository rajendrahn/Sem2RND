...
void testApp::setup() {
    ...
    openNIDevice.setupFromONI("/Users/rajendrahn/Downloads/hometest_single.oni");
...
void testApp::update(){
    ...
    int numberOfTrackedUsers = openNIDevice.getNumTrackedUsers();
    
    if( numberOfTrackedUsers > 0){
        ofxOpenNIUser user = openNIDevice.getTrackedUser(0); //get the 0th
